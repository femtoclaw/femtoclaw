...
### Added
- 14 LLM provider support: ollama, lmstudio, openai, openrouter, anthropic, grok, gemini, bedrock, azure, mistral, deepseek, perplexity, zen
- OpenRouter.ai integration (100+ models)
- LM Studio integration (local models)
- OpenCode Zen integration (curated coding models)

### Changed
- Version bump from 1.0.2 to 1.0.3
- Expanded brain module with 14 providers

## [1.0.2] - 2026-02-26

### Added
- Ollama brain support for local LLM inference
- Support for multiple brain backends: echo, openai, ollama

### Changed
- Version bump from 1.0.1 to 1.0.2
- Brain module refactored to support pluggable backends

### Fixed
- CLI now properly connected to Agent
